...
export const Bullseye = faIcon("fa-light fa-bullseye", "Bullseye");
export const Building = faIcon("fa-light fa-building", "Building");
export const BuildingColumns = faIcon("fa-light fa-building-columns", "BuildingColumns");
export const Calendar = faIcon("fa-light fa-calendar", "Calendar");
export const CreditCard = faIcon("fa-light fa-credit-card", "CreditCard");
export const Crosshairs = faIcon("fa-light fa-crosshairs", "Crosshairs");
export const Envelope = faIcon("fa-light fa-envelope", "Envelope");
...
export const Phone = faIcon("fa-light fa-phone", "Phone");
...
export const CircleQuestion = faIcon("fa-light fa-circle-question", "CircleQuestion");
export const InfoCircle = faIcon("fa-duotone fa-circle-info", "InfoCircle");